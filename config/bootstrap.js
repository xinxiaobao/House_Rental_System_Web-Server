...
module.exports.bootstrap = async function () {
  ...
  if (await House.count() == 0) {
    ...
    await House.createEach([
      { title: "沙田第一城1", ChineseName: "沙田第一城1", name: "City One Shatin", gross_area: 11, rent: 11, URL: "https://specials-images.forbesimg.com/imageserve/1026205392/960x0.jpg?fit=scale", bedrooms: 1, tenants: 1, box: true, },
